...
\end{definition}
\subsubsection{10/14/2025 Lecture 12}
\begin{remark}
    Review of last class:
    \begin{itemize}
...
\begin{theorem}[4.1.1]
    ...
    \begin{proof}
        ...
        \begin{align*}
            ...
            \text{Consider the transpose}: &= (\underbar{b}' - i \underbar{c}') (K_1 - i K_2)' (\underbar{b} + i \underbar{c})\\
            &= (\underbar{b}' - i \underbar{c}') (K_1 + i K_2) (\underbar{b} + i \underbar{c}) \text{since hermitian}\\
            &= b' K_1 b + c' K_1 c + 2 c' K_2 b \\
            &\geq 0
        \end{align*}
